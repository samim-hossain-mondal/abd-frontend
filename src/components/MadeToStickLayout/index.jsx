...
import makeRequest from '../utilityFunctions/makeRequestMadeToStick';
import {
  BACKEND_URL,
...
function MyGrid() {
  ...
  useEffect(() => {
    makeRequest(BACKEND_URL, GET_MADE_TO_STICK_CARDS, 'GET')
      .then((data) => {
        setCardDetails(data);
  ...
  return (
    <Box
      sx={{ backgroundColor: '#e6eef2', marginTop: '2%', paddingTop: '0.5%' }}>
      {isMobile === false && (
